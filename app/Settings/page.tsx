...
import "./Settings.css";
import  course_imagex from "../../public/Assets/community tab/user photo & story.svg";

const Settings = () => {
  return (
    <div> 

<form className="container-xl px-4 mt-4">
    ...
    <div className="col-xl-4">
      ...
      <div className="card mb-4 mb-xl-0">
        ...
        <div className="card-body text-center">
          ...
          <Image className="img-account-profile rounded-circle mb-2" src={course_imagex} alt="img" />
